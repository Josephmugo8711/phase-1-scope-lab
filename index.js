...
function upperCaseCustomerName(){
    //Write a function that accesses
...
//called bestCustomer in global scope and assigns it to be 'not bob'. (Poor Bob.) 
//Also, poor us, declaring a global variable from inside a function is one of those things we
// would never want to do normally, but is good for us to explore right now.
...
//(Poor Bob.) Also, poor us, declaring a global variable 
//from inside a function is one of those things we would never want to do normally, but is good for us to explore right now.
function overwriteBestCustomer(){
    bestCustomer = 'maybe bob';
}
//overwriteBestCustomer(): See the consequences of declaring a variable in global scope, 
//by writing a new function called
